...
$carta = "<h3 style='text-align:center;'>Mensaje para Venta corporativa de calcetines Suyoq</h3>";
...
try {
    ...
    $mail->Subject = 'Ventas Corporativas Suyoq.com';
    $mail->Body    = $carta;
    ...
    $mail->send();
    echo '<Script> alert("EL MENSAJE PARA LA VENTA CORPORATIVA SE ENVIO CORRECTAMENTE. \n GRACIAS POR CONTACTARNOS");    
    </Script>';
